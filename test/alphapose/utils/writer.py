...
class DataWriter():
    ...
    def get_save_path(self):
        return self.video_save_opt['savepath']
    
    def get_result(self):
        return self.video_save_opt['result']
    ...
    def update(self):
        ...
        while True:
            ...
            if orig_img is None:
                ...
                sys.path.append(os.path.abspath('../AcT/utils'))
                result = subprocess.run(['python3', '/home/homesecurity/CS281-Robbery-Detection/AcT/predict.py',
                                        f'{self.opt.outputpath}/alphapose-results.json'])
                # print('Inside test/alphapose/utils/writer.py', result.stdout)
                # print('Inside test/alphapose/utils/writer.py', result.stderr)
                # from predict import steal_result
                # print('writer result',result)
                # self.video_save_opt['result'] = result
                # print(result)
