    ...
    def get_data(self):
        if self.config['DATASET'] == 'kinetics':
            ...
            for k in range(1, 136):
                file_path: str = f'/home/homesecurity/CS281-Robbery-Detection/AlphaPose/examples/res/steal{k}/alphapose-results.json'
                ...
                for i in range(30):
                    ...
                    # first k == 1
                    # last k == 135 => k-1 == 134
                    new_kp_seq[k-1].append(extended_kp_seq[int(idx)])
            ...
            for k in range(1, 104):
                file_path: str = f'/home/homesecurity/CS281-Robbery-Detection/AlphaPose/examples/res/non-steal{k}/alphapose-results.json'
                with open(file_path, "r") as f:
                    data: List[Dict[str, Any]] = json.load(f)
                ...
                for i in range(30):
                    idx = int(i * multiplier)
                    # start from 134
                    new_kp_seq[134+k].append(extended_kp_seq[int(idx)])
